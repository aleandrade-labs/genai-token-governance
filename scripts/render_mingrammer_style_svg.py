...
def render_genai_governance_mingrammer_svg(output_path: str):
    svg = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1350 820" width="100%" height="100%" style="background-color: #ffffff; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif;" text-rendering="geometricPrecision" shape-rendering="geometricPrecision">
  <defs>
    <!-- Shadows -->
    ...
    <!-- ICONS -->
    <g id="icon-user">
      <rect width="64" height="64" rx="14" fill="#e8f0fe" />
    ...
    <g id="icon-scada">
      <rect width="64" height="64" rx="14" fill="#fef7e0" />
    ...
    <g id="icon-vertex">
      <rect width="64" height="64" rx="14" fill="#fce8e6" />
