...
CRITICAL: All connecting paths and polylines have explicit fill="none" to prevent SVG black polygon fill bugs.
"""
import os

def render_genai_governance_mingrammer_svg(output_path: str):
    svg = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1350 820" width="100%" height="100%" style="background-color: #ffffff; font-family: 'Google Sans', Roboto, -apple-system, BlinkMacSystemFont, Arial, sans-serif;">
  <defs>
    <!-- Shadows -->
  ...
  <!-- ==================== FLOW ARROWS (EXPLICIT fill="none") ==================== -->
...
"""
    ...
    with open(output_path, "w", encoding="utf-8") as f:
        f.write(svg)
    print(f"✅ Fixed & Rendered: {output_path}")
